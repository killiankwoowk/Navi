...
describe('ResponsiveLayout', () => {
  it('renders mobile layout without sidebars', () => {
    render(
      <ResponsiveLayout viewportMode="mobile" desktopSidebar={desktopSidebar} queueDock={queueDock}>
        {content}
      </ResponsiveLayout>,
    )
  ...
  it('renders tablet layout with tablet sidebar only', () => {
    render(
      <ResponsiveLayout viewportMode="tablet" desktopSidebar={desktopSidebar} queueDock={queueDock}>
        {content}
      </ResponsiveLayout>,
    )
  ...
  it('renders desktop layout with queue dock', () => {
    render(
      <ResponsiveLayout viewportMode="desktop" desktopSidebar={desktopSidebar} queueDock={queueDock}>
        {content}
      </ResponsiveLayout>,
    )
